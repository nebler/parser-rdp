...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_syntax_5ftree_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_syntax_5ftree_2eproto
{
  ...
  static const ::google::protobuf::internal::ParseTable schema[2] PROTOBUF_SECTION_VARIABLE(protodesc_cold);
...
namespace google
{
  ...
  {
    template <>
    ::syntax_tree::ASTNode *Arena::CreateMaybeMessage<::syntax_tree::ASTNode>(Arena *);
    template <>
    ::syntax_tree::SyntaxTree *Arena::CreateMaybeMessage<::syntax_tree::SyntaxTree>(Arena *);
  } // namespace protobuf
} // namespace google
namespace syntax_tree
{
  ...
  enum ASTNode_NodeType
  {
    ...
    ASTNode_NodeType_ASTNode_NodeType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
    ASTNode_NodeType_ASTNode_NodeType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
  };
  ...
  public:
    ...
    {
      return CreateMaybeMessage<ASTNode>(nullptr);
    }
  ...
  private:
    ...
    friend struct ::TableStruct_syntax_5ftree_2eproto;
  };
  // -------------------------------------------------------------------
  ...
  public:
    ...
    {
      return CreateMaybeMessage<SyntaxTree>(nullptr);
    }
...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
  ...
  inline const ::syntax_tree::ASTNode &SyntaxTree::root() const
  {
    ...
    return p != nullptr ? *p : *reinterpret_cast<const ::syntax_tree::ASTNode *>(&::syntax_tree::_ASTNode_default_instance_);
  }
...
namespace google
{
  namespace protobuf
  {
    ...
    template <>
    struct is_proto_enum<::syntax_tree::ASTNode_NodeType> : ::std::true_type
    {
    };
    template <>
